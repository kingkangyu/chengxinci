...
<!-- 登陆 -->
<div class="container">
	<form method="post" accept-charset="utf-8" action="<?php echo base_url('index'); ?>" class="form-horizontal login" role="form" >
		<div class="form-group">
	    	<label for="username" class="col-sm-3 control-label">用户名</label>
	    	<div class="col-sm-9">
	      		<input type="text" class="form-control" id="username" name="username"  placeholder="用户名" />
	      		<?php if(isset($flag)&&$flag==-2) echo "<span class='notice'>*用户名不存在</span>"; ?>
	   		</div>
	  	</div>
	 	<div class="form-group">
